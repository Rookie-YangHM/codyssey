...
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ----------------------------------------------------- |
| **Django**  | - 풀 스택 프레임워크 <sup>[1](#1)</sup> ([batteries-included][2])<br>- [ORM][3], 관리자 페이지, 인증 시스템 등 내장<br>- ["Don't Repeat Yourself" (DRY) 원칙][4] 강조            | - 빠른 개발 속도<br>- 강력한 보안 기능<br>- 대규모 프로젝트에 적합<br>- 활발한 커뮤니티와 풍부한 문서                                                            | - [학습 곡선][5]이 비교적 높음<br>- 소규모 프로젝트에는 다소 무거울 수 있음      | - 복잡하고 규모가 큰 웹 애플리케이션<br>- CMS, CRM, 소셜 네트워크 등        |
...
| **FastAPI** | - 최신 고성능 웹 프레임워크<br>- [Starlette(ASGI)][10] 기반, [Pydantic][11]으로 데이터 [유효성 검사][19] 및 [직렬화][12]<br>- [비동기][13]([async][14]/[await][15]) 지원 | - 매우 빠른 성능 (Node.js, Go에 필적)<br>- 자동 API 문서 생성 ([Swagger UI][16], [ReDoc][17])<br>- [타입 힌트 기반][18]으로 코드 자동 완성 및 [유효성 검사][19][^20] | - 비교적 새로운 프레임워크로 커뮤니티 규모가 작음<br>- 비동기 프로그래밍에 대한 이해 필요 | - 고성능 API 서버<br>- 마이크로서비스<br>- 데이터 과학 및 머신러닝 API      |
...
<a name="1">1</a> **프레임워크(Framework]** : 컴퓨터 프로그램을 만들 때 쓰는 **'미리 준비된 블록 세트'**, **'미리 준비된 도구 상자'**

여러분들이 레고 블록으로 집을 만든다고 상상해 보자.
...
<a name="2">2</a> **batteries-included**
...
<a name="3">3</a> **ORM (Object-Relational Mapping)**
...
<a name="4">4</a> **DRY 원칙 (Don't Repeat Yourself)**
...
<a name="5">5</a> **학습 곡선 (Learning Curve)**
...
<a name="6">6</a> **마이크로 프레임워크 (Microframework)**
...
<a name="7">7</a> **API (Application Programming Interface)**
...
<a name="8">8</a> **API 서버 (API Server)**
...
<a name="9">9</a> **RESTful API 서버 (RESTful API Server)**
...
<a name="12">12</a> **직렬화 (Serialization)**
...
<a name="13">13</a> **비동기 (Asynchronous)**
...
<a name="14">14</a> **async (비동기 함수 선언 키워드)**
...
<a name="15">15</a> **await (비동기 작업 대기 키워드)**
...
<a name="18">18</a> **타입 힌트 기반 (Type Hinting Based)**
...
<a name="19">19</a> **유효성 검사 (Validation)**
