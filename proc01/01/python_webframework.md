...
| **Flask**   | - [마이크로 프레임워크](#마이크로_프레임워크)<br>- 최소한의 기능만 제공<br>- 확장을 통해 기능 추가 (플러그인)                                                                              | - 가볍고 유연함<br>- 배우기 쉽고 시작하기 빠름<br>- 소규모 및 중간 규모 프로젝트에 적합<br>- [API 서버](#API서버) 구축에 용이                                              | - 필요한 기능을 직접 구성해야 함<br>- 대규모 프로젝트에서는 관리가 복잡해질 수 있음    | - 소규모 웹 애플리케이션<br>- [RESTful API 서버](#RESTful_API_서버)<br>- 프로토타입 개발 |
